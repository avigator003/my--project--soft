            ...
            {loading ? (
             ...
             onSelectionsChange={onSelectionsChange} />
                        ...
                        <View style={{ marginBottom: 20,display:"flex",flexDirection:"row" }}>
                                <Text style={{fontWeight:"bold",fontSize:wp("4%"),flex:0.4,top:10}}>Name</Text>
                                <TextInput
                            ...
                            <View style={{ marginBottom: 20,display:"flex",flexDirection:"row" }}>
                                <Text style={{fontWeight:"bold",fontSize:wp("4%"),top:10,flex:0.4}}>Mobile No.</Text>
                                <TextInput
                                    style={[styles.input, { backgroundColor: "#D3FD7A" }]}
                            ...
                            <View style={{ marginBottom: 20,display:"flex",flexDirection:"row" }}>
                                <Text style={{fontWeight:"bold",fontSize:wp("4%"),flex:0.4,top:10}}>Address</Text>
                                <TextInput
                                    style={[styles.input, { backgroundColor: "#D3FD7A" }]}
                            ...
                            <View style={{ marginBottom: 20,display:"flex",flexDirection:"row" }}>
                                <Text style={{fontWeight:"bold",fontSize:wp("4%"),flex:0.4,top:10}}>City</Text>
